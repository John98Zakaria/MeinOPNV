...
const ding = makeRequest({
    ...
    session: {
        new: false,
        sessionId:
            'amzn1.echo-api.session.d44a4121-b059-4295-8289-4b12103ff647',
        application: {
            applicationId:
                'amzn1.ask.skill.89f9587f-84f1-4005-9478-f0844a5221f1',
        },
        attributes: {},
        user: {
    ...
    context: {
        ...
        System: {
            ...
            device: {
                deviceId:
                    'amzn1.ask.device.AH66SKW2ZHCGN7E3YDCKIERKYGWZEF4VRCP5VGKBZ322FFDQEZWKIWB54S64ICIK44VMOMSKCSIEAXLUGHGLJEUVYFHZEESZ5FQTNJ7R7BVU2ZFZLWNJDMXFVEI5YXF2MCBZ77W237TGC6P3L3CR52HN5Y7KXYILUFHCLRVMOU62V2I3F73VG',
                supportedInterfaces: {},
            },
    ...
    request: {
        type: 'IntentRequest',
        requestId:
            'amzn1.echo-api.request.79e818fc-7112-4629-8ec0-7e858bc271ad',
        locale: 'de-DE',
                ...
                bekannterOrt: {
                    ...
                    resolutions: {
                        resolutionsPerAuthority: [
                            {
                                authority:
                                    'amzn1.er-authority.echo-sdk.amzn1.ask.skill.89f9587f-84f1-4005-9478-f0844a5221f1.BekannteOrte',
                                status: {
